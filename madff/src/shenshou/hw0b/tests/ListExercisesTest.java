...
public class ListExercisesTest {
    ...
    public void testSum() {
        // List<Integer> lst1 = List.of(1, 2, 3, 4);  unavailable in Java 8
        List<Integer> lst1 = Collections.unmodifiableList(Arrays.asList(1, 2, 3, 4));
